---
title: Sex-specific associations between psychological resilience and blastocyst quality.
domain: medical-research
tier: 01-Raw
entry_id: medical-research-blastocyst-sex-specific-associations-between-psychological-resilience-and-blastocyst-quality
source_url: https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=pubmed&id=42565463&retmode=xml
source_type: api
source_platform: pubmed
collected_at: 2026 Aug 07
summary: A prospective study of 126 infertile couples undergoing ICSI found that higher psychological resilience in men, but
  not women, was associated with better sperm characteristics and a higher rate of good-quality blastocysts. Male resilience
  positively correlated with sperm morphology and negatively with sperm histone retention, suggesting psychological factors
  in men may influence reproductive outcomes.
tags:
- blastocyst
- infertility
...
previous_version: 0
supersedes: ''
trace_id: 0d4bd61a-b434-444f-b675-23eb4ff7fba3
quality_flags:
...
LAY SUMMARY: Psychological resilience is the ability to adapt to and recover from stressful situations. Infertility treatment can be emotionally challenging for couples, but it is not known whether resilience is related to laboratory outcomes during treatment. In this study, we assessed psychological resilience in 126 couples undergoing intracytoplasmic sperm injection, a fertility treatment in which one sperm is injected into each mature egg. We found that higher resilience in men was associated with better sperm characteristics and a higher rate of good-quality embryos reaching the blastocyst stage on Day 5. This association was not observed in women. These findings suggest that psychological factors in men may be linked to biological features relevant to reproduction. However, this was an observational study and cannot prove cause and effect. Larger studies are needed to confirm these findings and to understand the biological mechanisms involved.

## Summary
A prospective study of 126 infertile couples undergoing ICSI found that higher psychological resilience in men, but not women, was associated with better sperm characteristics and a higher rate of good-quality blastocysts. Male resilience positively correlated with sperm morphology and negatively with sperm histone retention, suggesting psychological factors in men may influence reproductive outcomes.

## Key Points
- Higher psychological resilience in men was independently associated with a higher Day 5 good-quality blastocyst development rate (B = 0.06, 95% CI 0.01-0.11, p = 0.02).
- No significant association was found between women's resilience and blastocyst quality.
- Male resilience was positively correlated with sperm morphology (ρ = 0.28, p = 0.001) and inversely correlated with sperm histone retention (ρ = -0.26, p = 0.02).
- The study was observational and cannot prove causation; larger studies are needed to confirm findings and explore biological mechanisms.


## Entities
- **psychological resilience** (concept, relevance=)
- **blastocyst quality** (concept, relevance=)
- **intracytoplasmic sperm injection** (procedure, relevance=)
- **Connor-Davidson Resilience Scale** (technology, relevance=)
- **infertility treatment** (concept, relevance=)
- **sperm histone retention** (concept, relevance=)
- **sperm morphology** (concept, relevance=)
