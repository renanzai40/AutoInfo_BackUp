...
summary: This study proposes a deep learning-based method using a modified GoogLeNet architecture with transfer learning to
  improve embryo selection accuracy in IVF. The model achieved 97.47% accuracy, precision, recall, and 97.46% F1-score, outperforming
  previous methods. The approach also reduces false positives and may improve IVF success rates.
tags:
- Blastocyst
- Deep Learning
- Embryo
...
## Summary
This study proposes a deep learning-based method using a modified GoogLeNet architecture with transfer learning to improve embryo selection accuracy in IVF. The model achieved 97.47% accuracy, precision, recall, and 97.46% F1-score, outperforming previous methods. The approach also reduces false positives and may improve IVF success rates.

## Key Points
- About 14% of couples experience infertility, and IVF success rates remain around 30%, highlighting the need for better embryo selection.
- Traditional morphological assessment is subjective and limited; deep learning offers objective, automated evaluation.
- The proposed modified GoogLeNet architecture achieved 97.47% accuracy, precision, recall, and 97.46% F1-score on embryo classification.
- The model integrates transfer learning, batch normalization, dropout, and customized preprocessing to improve generalization across imaging systems.
- The method outperformed baseline GoogLeNet (91.27%), transfer learning GoogLeNet (93.47%), and prior studies like Xception (91.47%).
...
- **Embryo selection** (concept, relevance=)
