...
/ 10 unconfigured**; the suite has since grown to 117 (65 functional + 52 regression; §1.8) — the baseline shape (all
...
117 scenario files in `src/autoinfo/mcp/scenarios/` (65 functional flat in `scenarios/`
+ 52 regression in `scenarios/regression/`):
