...
| Validation scenarios | ✅ 70 scenarios (64 functional + 6 regression in `scenarios/regression/`, `regression: true` key, recursive-glob auto-load) |
...
3. **Validate** — `list_validation_scenarios()` (70 scenarios: 64 functional + 6 regression) → `run_validation_scenario(scenario="system-health")`
