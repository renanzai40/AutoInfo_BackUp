...
| Validation scenarios | ✅ 106 scenarios (64 functional + 42 regression in `scenarios/regression/`, `regression: true` key, recursive-glob auto-load) |
...
3. **Validate** — `list_validation_scenarios()` (106 scenarios: 64 functional + 42 regression) → `run_validation_scenario(scenario="system-health")`
