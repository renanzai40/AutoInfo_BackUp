...
| Validation scenarios | ✅ 105 scenarios (64 functional + 41 regression in `scenarios/regression/`, `regression: true` key, recursive-glob auto-load) |
...
3. **Validate** — `list_validation_scenarios()` (105 scenarios: 64 functional + 41 regression) → `run_validation_scenario(scenario="system-health")`
