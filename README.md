...
| Validation scenarios | ✅ 110 scenarios (64 functional + 46 regression in `scenarios/regression/`, `regression: true` key, recursive-glob auto-load) |
...
| Regression flywheel | ✅ `scenarios/regression/` (46 regression scenarios) + `coverage_audit.py` "Regression scenarios: N" metric + `.github/ISSUE_TEMPLATE/bug_report.md` mandatory 回归场景 field |
...
3. **Validate** — `list_validation_scenarios()` (110 scenarios: 64 functional + 46 regression) → `run_validation_scenario(scenario="system-health")`
...
AutoInfo has evolved through v1.3-v1.8.4 with major feature additions at each release. See [CHANGELOG.md](CHANGELOG.md) for the full version history. Notable v1.8.2-v1.8.4 additions: bundle export, delivery schedules, podcast RSS publishing (C11), HackerNews collector, MCP-native validation toolset (44→57→59 scenarios in 2026-08-05→07, incl. the 6-scenario regression flywheel; the kb-curation wave grew it to 65 on 2026-08-08; the output-quality-mega wave grew it to 67 on 2026-08-11 and the output-video scenario brought it to 68 (62 functional + 6 regression) on 2026-08-13 with premium-briefing/enterprise-briefing templates + collector fulltext depth; the AC4 kb-tier-matrix scenario grew it to 70 (64 functional + 6 regression) on 2026-08-16 and the #288 regression-financial-sources scenario grew it to 71 (64 functional + 7 regression) on 2026-08-17), B23 ebook/audiobook output, version unification at 1.8.1 (see `src/autoinfo/_version.py`); CHANGELOG documents v1.9/v1.10 as Unreleased; the #290-#315 waves grew the validation library to 89 (64 functional + 25 regression) and the #316-#319 wave grew it to 93 (64 functional + 29 regression) on 2026-08-19; the #322-#323/#314 wave grew it to 96 (64 functional + 32 regression); the #325-#326 wave grew it to 98 (64 functional + 34 regression); the #328-#329 wave grew it to 100 (64 functional + 36 regression); the #331-#332 wave grew it to 102 (64 functional + 38 regression); the #334-#336 wave grew it to 105 (64 functional + 41 regression); the #338 wave grew it to 106 (64 functional + 42 regression); the #340 wave grew it to 107 (64 functional + 43 regression); the #342 wave grew it to 108 (64 functional + 44 regression); the #332-B wave grew it to 109 (64 functional + 45 regression); the #325 wave grew it to 110 (64 functional + 46 regression). The following items remain explicitly deferred:
