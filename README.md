...
| Validation scenarios | ✅ 137 scenarios (65 functional + 72 regression in `src/autoinfo/mcp/scenarios/regression/`, `regression: true` key, recursive-glob auto-load) |
...
3. **Validate** — `list_validation_scenarios()` (137 scenarios: 65 functional + 72 regression) → `run_validation_scenario(scenario="system-health")`
